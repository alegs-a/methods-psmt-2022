    ...
    \begin{figure} % Sectioned data
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    ...
                    xlabel = {Width (m)},
                    ylabel = {Height (m)},
                    xlabel = {Distance from left side of dam (m)},
                    ylabel = {Height of dam (m)},
                    xmajorgrids = true,
                    ymajorgrids = true
                ]
        ...
        \begin{figure}
            ...
            \begin{tikzpicture}
                \begin{axis}[
                        title = {\textbf{Raw data points}},
                        xlabel = {Time (days)},
                        ylabel = {Area covered (m)},
                        xmajorgrids = true,
                        ymajorgrids = true,
                        legend pos = north west
                    ]
                    \addplot+[only marks]table[x=x, y=y]{data/bacteriaData.txt};\addlegendentry{Data point}
                    \addplot+[mark = none, domain = 0:20, smooth]{1.669188*e^(0.284009*x)};\addlegendentry{Exponential model}
                    \addplot+[color = green, mark = none, domain = 0:20, smooth]{2.08195*x^2 - 22.5996*x + 27.9101};\addlegendentry{Quadratic model}
                    \addplot+[color = cyan, mark = none, domain = 0:20, smooth]{0.198115*x^3 + -3.94396*x^2 + 23.786*x + -19.0402};\addlegendentry{Cubic model}
                \end{axis}
            \end{tikzpicture}
            \caption{Raw data and regression models of bacteria population}
